...
let randomNumber;    // Variable to store random number generated by getRandomQuote();
let randomQuote;     // Variable to store random quote generated by getRandomQuote();
...
const colors = ["#023059", "#035E72", "#36A59A", "#F56469", "#F5A187", "#BB4043", "#4073B8", "#B3640F", "#5D1314"]
...
const printQuote = () => {
  let finalQuote = ''; // Variable to store the final quote to be produced using printRandomQuote();
